...
public class EntityMapper {
    ...
    public ClientDTO mapClientToClientDTO(Client client) {
        return new ClientDTO(client.getName(), client.getEmail(), client.getCity());
    }
    ...
    public AvailabilityDTO mapAvailabilityToAvailabilityDTO(Availability availability) {
        return new AvailabilityDTO(availability.getServiceOption().getName(), availability.getAvailableDate(),
                availability.getAvailableHours());
    }

    public List<AvailabilityDTO> mapAvailabilityListToAvailabilityListDTO(List<Availability> availabilityList) {
        return availabilityList.stream()
                .map(this::mapAvailabilityToAvailabilityDTO)
                .collect(Collectors.toList());
    }
    ...
    public BusinessOwnerDTO mapBusinessProfileToBusinessOwnerProfile(BusinessProfile businessProfile) {
        return new BusinessOwnerDTO(businessProfile.getOwner().getName(), businessProfile.getOwner().getLastName(),
                businessProfile.getId(), businessProfile.getBusinessName(), businessProfile.getBusinessAddress(),
                businessProfile.getCity());
    }

    public List<BusinessOwnerDTO> mapBusinessProfileListToBusinessOwnerListDTO(List<BusinessProfile> businessProfileList) {
        return businessProfileList.stream()
                .map(this::mapBusinessProfileToBusinessOwnerProfile)
                .collect(Collectors.toList());
    }
